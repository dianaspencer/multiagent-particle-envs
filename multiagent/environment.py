    ...
    def __init__(self,
        ...
        for agent in self.agents:
            ...
            if self.discrete_action_space:
                u_action_space = gym.spaces.Discrete(world.dim_p * 2 + 1)
            else:
                u_action_space = gym.spaces.Box(low=-agent.u_range, high=+agent.u_range, shape=(world.dim_p,), dtype=np.float32)
            ...
            if self.discrete_action_space:
                c_action_space = gym.spaces.Discrete(world.dim_c)
            else:
                c_action_space = gym.spaces.Box(low=0.0, high=1.0, shape=(world.dim_c,), dtype=np.float32)
